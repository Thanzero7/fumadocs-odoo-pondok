...
<div className="video-embed-modern">
  <iframe 
    src="https://www.youtube.com/embed/2NWXfBM-l3g?rel=0&modestbranding=1" 
    title="Jam Pelajaran Tutorial"
    frameBorder="0" 
...
2.  Buka modul **Sekolah**, lalu klik menu **Pengaturan** kemudian pilih submenu **Jam Pelajaran**.
    ...
    <figure><img src="/assets/images-272.png" alt="" /><figcaption></figcaption></figure>

3.  Klik tombol **"Baru"** untuk membuat data jam pelajaran baru

    <figure><img src="/assets/images-273.png" alt="" /><figcaption></figcaption></figure>
...
4.  Akan tampil halaman form, isi inputan yang tersedia seperti:
    ...
    * **Jam Selesai** (masukkan jam pelajaran berakhir).
    ...
    <figure><img src="/assets/images-274.png" alt="" /><figcaption></figcaption></figure>
...
5.  Setelah semua inputan diisi dengan benar, klik ikon **Simpan** di sebelah kanan ikon **Gear** agar data jam pelajaran tersimpan di sistem.
    ...
    <figure><img src="/assets/images-275.png" alt="" /><figcaption></figcaption></figure>
